...
@Setter
@ToString
public class PrescriptionRoutineQueryDto {
    private Long id;
    ...
    @QueryProjection
    public PrescriptionRoutineQueryDto(Long id, String customName, Integer iotLocation, Integer medicineShape, Boolean took) {
        this.id = id;
