...
public interface MedicineRoutineCheckService {
    ...
    List<MedicineRoutineMonthDateDto> getMonthResultsByMonthAndMember(YearMonth yearMonth, Long requesterId, Long requesteeId); // 한달 단위 조회

    MedicineRoutineDateResponseDto getDateDetailResultsByDateAndMember(LocalDate date, Long requesterId, Long requesteeId);  // 하루 단위 복용 상세 조회
