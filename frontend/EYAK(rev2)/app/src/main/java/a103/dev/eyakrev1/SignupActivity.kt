...
import a103.dev.eyakrev1.databinding.ActivitySignupBinding
...
//                    startActivity(intent)
    ...
    private fun trySignUp(nickName: String, wakeTimeH: String, wakeTimeM: String, breakfastTimeH: String, breakfastTimeM: String,
        ...
        val data = a103.dev.eyakrev1.SignUpBodyModel(
            providerName = "google",
            ...
            }:${pref.getString("KEY_WAKE_TIME_M", "50")}:00",
            breakfastTime = "${
                pref.getString(
                    "KEY_BREAKFAST_TIME_H",
                    "07"
                )
            }:${pref.getString("KEY_BREAKFAST_TIME_M", "20")}:00",
            lunchTime = "${
                pref.getString(
                    "KEY_LUNCH_TIME_H",
                    "11"
                )
            }:${pref.getString("KEY_LUNCH_TIME_M", "10")}:00",
            dinnerTime = "${
                pref.getString(
                    "KEY_DINNER_TIME_H",
                    "19"
                )
            }:${pref.getString("KEY_DINNER_TIME_M", "20")}:00",
            bedTime = "${pref.getString("KEY_BED_TIME_H", "01")}:${
                pref.getString(
                    "KEY_BED_TIME_M",
                    "00"
                )
            ...
            }:${pref.getString("KEY_EATING_TIME_M", "20")}:00"
        )
