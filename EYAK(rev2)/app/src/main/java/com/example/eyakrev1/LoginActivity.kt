...
//            Toast.makeText(this, "구글 로그인 하고 싶어요", Toast.LENGTH_SHORT).show()
            ...
            oneTapClient.beginSignIn(signInRequest)
                ...
                .addOnFailureListener(this) { e ->
                    ...
                    Toast.makeText(this, "여기까지 온다", Toast.LENGTH_SHORT).show()
                }
        }
    }
                ...
                try {
                    ...
                    when {
                        ...
                        password != null -> {
                            ...
                            Toast.makeText(this, "Got password.", Toast.LENGTH_SHORT).show()
                        }
                        else -> {
                            // Shouldn't happen.
                            Log.d(TAG, "No ID token or password!")
                            Toast.makeText(this, "No ID token or password!", Toast.LENGTH_SHORT).show()
                        }
                    }
                } catch (e: ApiException) {
                    // ...
                    Toast.makeText(this, "뭔가 안됨", Toast.LENGTH_SHORT).show()
